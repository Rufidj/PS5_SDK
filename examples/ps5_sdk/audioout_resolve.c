...
void _start(u64 eboot_base, u64 dlsym_addr, struct ext_args *ext) {
    ...
    void *output_fn = ex_sym_module(&ex, "libSceAudioOut.sprx", AUDIOOUT_sceAudioOutOutput);
    void *close_fn = ex_sym_module(&ex, "libSceAudioOut.sprx", AUDIOOUT_sceAudioOutClose);
    void *volume_fn = ex_sym_module(&ex, "libSceAudioOut.sprx", AUDIOOUT_sceAudioOutSetVolume);
    void *state_fn = ex_sym_module(&ex, "libSceAudioOut.sprx", AUDIOOUT_sceAudioOutGetSystemState);
