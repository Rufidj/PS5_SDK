...
void _start(u64 eboot_base, u64 dlsym_addr, struct ext_args *ext) {
    ...
    void *init_fn = ex_sym_module(&ex, "libSceAudioOut.sprx", "sceAudioOutInit");
    void *open_fn = ex_sym_module(&ex, "libSceAudioOut.sprx", "sceAudioOutOpen");
    void *output_fn = ex_sym_module(&ex, "libSceAudioOut.sprx", "sceAudioOutOutput");
    void *close_fn = ex_sym_module(&ex, "libSceAudioOut.sprx", "sceAudioOutClose");
